...
by applying all transactions that \todo{transactions are not confirmed} have been confirmed so far in the head. As the
...
\dparagraph{Closing the head.} A party that wants to close the head decommits
