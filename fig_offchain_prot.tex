\begin{figure*}[t!]
  ...
  \def\sfact{0.8}
  \centering
  \begin{algobox}{Coordinated Hydra Head}\label{fig:off-chain-prot}
    \medskip
    \begin{tabular}{c}
        ...
        \begin{walgo}{0.65}
          ...
          \On{$(\hpRS,s,\mT^{\#}_{req})$ from $\party_j$}{ %
            ...
            \Wait{$\bars = \hats ~ \land ~ \forall h \in \mT^{\#}_{req} : (h, \cdot) \in \mT$}{ %
              \mf{no more $\mT$, and $\hatmT$ may never contain $h$}
              
              % resolve requested transactions
              $\mT_{res} \gets \{ \mT[h] ~ | ~ h \in \mT^{\#}_{req}\}$
              ...
              \Wait{$\barmU \applytx \mT_{res} \not= \bot$}{ %
                ...
                \mf{include MT-hash of included txs in $\eta'$?}
