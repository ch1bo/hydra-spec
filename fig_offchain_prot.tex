    ...
    \begin{tabular}{c}
        ...
        \adjustbox{valign=t,scale=\sfact}{
         \begin{walgo}{0.65}
          ...
          \On{$(\hpInit,i,\hpPuv,\hpPr,\Uinit)$ %
            ...
            % TODO: this should also postTx init?
          }
      ...
      \begin{tabular}{c c}
        ...
        \begin{walgo}{0.6}
          ...
          \On{$(\gcChainInitial)$}{ %
           \Req $\hpAKchain=\hpAKinit$\; %
           \Req $\hMT=H_{\mathsf{Merkle}}(\hppuv)$ \; %
           $\gcChainRef.\gcChainPost(\mtxCom,U)$ \; %
          }

          \vspace{12pt}

          \On{$(\gcChainInitialTO)$}{ %
            \eIf{(all members committed)}{
              $\gcChainRef.\gcChainPost(\mtxCCom)$ \; %
            }{
              $\gcChainRef.\gcChainPost(\mtxAbort)$ \; %
            }
          }
        ...
        & \adjustbox{valign=t,scale=\sfact}{
          ...
          \On{$(\gcChainCollectCom)$}{ %
            $(\Uinit,\cdot,\cdot)\gets\ocvInitial(U_{p_1},\dots,U_{p_n})$ \; %
            $\gcHeadRef.(\hpInit,i,\hpPuv,\hpPri{i},\Uinit)$ \; %
          }

          \vspace{12pt} %

          \On{$(\gcChainClose)$}{ %
            $\eta'=(\cdot,s') \gets \ocvClose(\hpAK,\eta,\xi)$ \;
            \If{$\bars > s'$}{%
              $\xi \gets (\barmU.U, \barmU.s, \barmU.\msCSig)$ \; %
          ...
          \On{$(\gcChainContest)$}{ %
            $\eta'=(\cdot,s') \gets \ocvContest(\hpAK,\eta,\xi)$ \; %
            \If{$s>s'$}{
              $\xi \gets (\barmU.U, \barmU.s, \barmU.\msCSig)$ \; %
              $\gcChainPost(\mtxContest,\xi)$ \; %
            }
          ...
          \On{$(\gcChainClosedTO)$}{ %
            $\gcChainRef.\gcChainPost(\mtxFanout)$ \; %
          }
          \end{walgo}
          }
