...
\begin{figure}[h]\label{fig:SM-init-commit}
  \centering
  \includegraphics[width=0.8\textwidth]{figures/SM-init-commit.pdf}
...
\begin{figure}[h]\label{fig:SM-collect}
  \centering
