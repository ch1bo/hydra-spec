...
by~\cite{eutxo-2}~and~\cite{eutxo}.\todo{handwavy} Values $x$ are of a set
...
\todo{define before} $\tyData$ is a universal data type, and we denote an empty value of type $\tyData$ by $\emptyset$
