...
\begin{itemize}
	\item $\mathcal{A}^? = \mathcal{A} \cup \Diamond$ denotes an option: a value from $\matcal{A}$ or no value at all,
...
\begin{definition}[Validation Context]
	...
	$(\txValidityMin, \txValidityMax) \in \tyValidity$ \todo{$\tyValidity$
		undefined, define time, periods and intervals} are the lower and upper
