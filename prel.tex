...
\begin{definition}[Validation Context]
  ...
  \textbf{list} of outputs of length $v$, $\txMint \in \tyValue$ is the
  ...
  the lower and upper validity bounds, and $\txKeys \in \mathcal{K}$ is the set of
...
\begin{mitemize}
  ...
  \item either
    ...
    \end{mitemize}
\end{mitemize}\todo{Define that $\cemDatum'$ needs to be included to be resolvable}
